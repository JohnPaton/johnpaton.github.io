...
BLOG_AUTHOR = "John Paton"  # (translatable)
BLOG_TITLE = "John's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://johnpaton.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "john@johnpaton.net"
BLOG_DESCRIPTION = "John Paton's personal blog"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "johnpatonblog"
